...
public class AndroidBasicInteractionsJavaTest extends BaseTest {
	
	public static void main(String[] args) throws Exception {
	    AndroidDriver<WebElement> driver;
	    final String SEARCH_ACTIVITY = ".app.SearchInvoke";
	    final String ALERT_DIALOG_ACTIVITY = ".app.AlertDialogSamples";
	    final String PACKAGE = "io.appium.android.apis";		
